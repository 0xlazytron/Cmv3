        ...
        <main>
                    ...
                    <div id="top-section"
                        ...
                        <div className="av-section-color-overlay-wrap">
                            <div className="av-section-color-overlay" style={{ opacity: "0.8", backgroundColor: "#ffffff" }}>
                                ...
                                <a
                                href="#next-section" title="" className="scroll-down-link " style={{height:"40px", width:"40px"}}>
                                    <img src={down} alt="" />
                            ...
                            <div className="container">
                                <main role="main"
                                    ...
                                    <div className="post-entry post-entry-type-page post-entry-8872">
                                            ...
                                            <div className="flex_column_table av-equal-height-column-flextable -flextable">
                                                    ...
                                                    <section className="av_textblock_section">
                                                        <div className="avia_textblock">
                                                            <p style={{ textAlign: "center", color: "#000" }}>
                                                                You own {" "} {(balance || 0).toLocaleString()} SOL In Your Wallet</p>
                                                        </div>
                                                    </section>
                                                </div>
                                                <div className="flex_column av_three_fifth  no_margin flex_column_table_cell av-equal-height-column av-align-middle   avia-builder-el-4  el_after_av_two_fifth  avia-builder-el-last  newslatter-frm "
                                                    ...
                                                    <div style={{ paddingBottom: "10px", margin: "0px 0px 0px 0px", color: "#53632e" }}
                                                        ...
                                                        <h1 className="av-special-heading-tag ">one more step&hellip;
                                                        </h1>
                                                    ...
                                                    <section className="av_textblock_section ">
                                                        <div className="avia_textblock  av_inherit_color " style={{ color: "#999999" }}>
                                                            ...
                                                            <p style={{ textAlign: "center" }}>
                                                                you have paid the solana now next we will deduct the required DBC to Mint your Grapevine NFTree
                                                                {/* {whitelistTokenBalance < 250 ? "You need at least 250 DBC and 1 Solana in your wallet to mint a Golden Grapevine NFT" : "You Can Mint GrapeVine NFT"} */}
                                                            </p>
                                                            </em>
                                                        </div>
                                                    </section>
                                                    <div
                                                        className=" avia-button-center">
                                                            ...
                                                            {wallet && isActive && <BorderLinearProgress variant="determinate"
                                                                value={100 - (itemsRemaining * 100 / itemsAvailable)} />}</p> <br /> */}
                                                        <span
            ...
            {/* <MainContainer>
                ...
                <MintContainer>
                    <DesContainer>
                        <NFT elevation={3}>
                            <h2>Buy the Grapevine NFTree</h2>
                            <br/>
                            <div><Price
