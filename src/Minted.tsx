...
const Minted = (props: HomeProps) => {
    ...
    async function getToken(){
        const collectibles  = await props.connection.getTokenAccountsByOwner(anchorWallet!.publicKey, {programId: TOKEN_PROGRAM_ID},"confirmed");
        
        const getn = await  props.connection.getAccountInfo(anchorWallet!.publicKey,"confirmed")
       console.log(collectibles.value);
       console.log(getn?.owner.toString);   
      }
                ...
                <div id="main" className="all_colors" data-scroll-offset="70">
                    <div id="top-section"
                        ...
                        <div className="av-section-color-overlay-wrap">
                            <div className="av-section-color-overlay" style={{ opacity: "0.8", backgroundColor: "#ffffff" }}>
                                </div>
                                <a
                                 title=""  className="scroll-down-link " style={{height:"40px", width:"40px"}}>
                                    <img src={down} alt="" />
                                            ...
                                            <div className="flex_column_table av-equal-height-column-flextable -flextable">
                                                        ...
                                                        <div className="avia-image-container-inner">
                                                            <div className="avia-image-overlay-wrap">
                                                                <img
                                                                    ...
                                                                    src={aw} alt=""
                                                                    title="Domein Bergen" height="289" width="300" />
                                                                    </div>
                                                ...
                                                <div className="flex_column av_three_fifth  no_margin flex_column_table_cell av-equal-height-column av-align-middle   avia-builder-el-4  el_after_av_two_fifth  avia-builder-el-last  newslatter-frm "
                                                    ...
                                                    <div style={{ paddingBottom: "10px", margin: "0px 0px 0px 0px", color: "#53632e" }}
                                                        ...
                                                        <h1 className="av-special-heading-tag ">Your Grapevine NFTree!
                                                        </h1>
                                                    ...
                                                    <section className="av_textblock_section ">
                                                        <div className="avia_textblock  av_inherit_color " style={{ color: "#999999" }}>
                                                            <em>
                                                            <p style={{ textAlign: "center", color:"#53632e" }}>
                                                                This NFT is a proof of a lifetime ownership to a specific
														grapevine on Dutch organic vineyard: Domein Bergen. This NFT
														entitles you to an equivalent share of the vineyard&rsquo;s
														bottled yields.
                                                    ...
                                                    <div
                                                        ...
                                                        <a
                                                            className="avia-button-center  avia-size-small avia-position-center" href="https://opensea.io/es/collection/grapevine-nftree"  target="_blank">
